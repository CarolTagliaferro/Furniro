  ...
  return (
    <div className="bg-mediumBg h-28 font-poppins flex lg:justify-between items-center">
      <div className="flex items-center lg:ml-20 ml-5">
        <button>
          <img
            src="https://furniro-at.s3.amazonaws.com/Icons/filterIcon.png"
            alt="Filter"
            className="pr-2"
          />
        </button>
        ...
        <img
          src="https://furniro-at.s3.amazonaws.com/Icons/dotsIcon.png"
          alt="Dots"
          className="lg:pr-5 pr-2"
        />
        <img
          src="https://furniro-at.s3.amazonaws.com/Icons/view-listIcon.png"
          alt="List"
          className="lg:pr-10 pr-2"
        />
